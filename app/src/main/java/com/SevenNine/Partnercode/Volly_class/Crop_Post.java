package com.SevenNine.Partnercode.Volly_class;
...
//                    DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
    ...
    public static void getProfileDetails(Activity activity, String url, JSONObject postObject, final VoleyJsonObjectCallback callback) {
       /* final ProgressDialog progressDialog = ProgressDialog.show(activity, "",
                "Loading....Please wait.");*/
...
//                    DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
    ...
    public static void lang_posting(Activity activity, String url, JSONObject postObject, final VoleyJsonObjectCallback callback) {
        /*final ProgressDialog progressDialog = ProgressDialog.show(activity, "",
                "Loading....Please wait.");*/
