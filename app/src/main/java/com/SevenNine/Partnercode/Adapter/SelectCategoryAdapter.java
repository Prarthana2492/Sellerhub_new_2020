...
import com.SevenNine.Partnercode.Fragment.SelectSubCategoryFragment;
...
public class SelectCategoryAdapter extends RecyclerView.Adapter<SelectCategoryAdapter.MyViewHolder> {
    ...
    public static String sellingtypeid,selling_category_id,sellingname;



    public SelectCategoryAdapter(Activity activity, List<Sellbean> moviesList) {
