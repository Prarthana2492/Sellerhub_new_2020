...
public class PreviewEvent_Adapter extends RecyclerView.Adapter<PreviewEvent_Adapter.MyViewHolder>  {
    ...
    public PreviewEvent_Adapter(Activity activity, List<AddTractorBean> moviesList) {
