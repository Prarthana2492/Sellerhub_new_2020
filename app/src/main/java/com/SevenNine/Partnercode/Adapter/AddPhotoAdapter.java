...
import com.SevenNine.Partnercode.Bean.AddPhotoBean;
import com.SevenNine.Partnercode.Fragment.CameraFragment;
...
public class  AddPhotoAdapter extends RecyclerView.Adapter<AddPhotoAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (position == productList.size()-1 ) {
            ...
            holder.add_text_image.setVisibility(View.GONE);
        ...
        holder.image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (productList.size()<5){
                    ...
                    transaction.addToBackStack("add_photo");
                    transaction.commit();
