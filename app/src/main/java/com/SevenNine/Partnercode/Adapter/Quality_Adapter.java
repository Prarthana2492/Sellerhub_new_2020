...
public class Quality_Adapter extends RecyclerView.Adapter<Quality_Adapter.MyViewHolder> {
    ...
    public Quality_Adapter(Activity activity, List<SelectLanguageBean> moviesList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        quality_id= products.getLanguageid();
    ...
    /* holder.variety_txt.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View view) {
             AddCrops_Fragment.quality.setText(products.getVendor());
