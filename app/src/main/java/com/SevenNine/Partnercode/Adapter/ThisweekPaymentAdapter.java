...
public class ThisweekPaymentAdapter extends RecyclerView.Adapter<ThisweekPaymentAdapter.MyViewHolder>  {
    ...
    public ThisweekPaymentAdapter(Activity activity, List<TodayPaymentBean> moviesList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
     ...
     // holder.name.setText(products1.getName()+", "+products1.getMob_no());
      ...
      holder.amount.setText("Rs."+formatter.format(rate_double1));
