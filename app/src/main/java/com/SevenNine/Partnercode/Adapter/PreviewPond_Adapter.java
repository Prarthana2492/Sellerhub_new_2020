...
public class PreviewPond_Adapter extends RecyclerView.Adapter<PreviewPond_Adapter.MyViewHolder>  {
    ...
    public PreviewPond_Adapter(Activity activity, List<AddTractorBean> moviesList) {
