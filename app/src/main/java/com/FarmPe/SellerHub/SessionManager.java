...
import com.FarmPe.SellerHub.Activity.NewSignUpActivity;
...
/////
    ...
    public void checkLogin(){
        System.out.println("in here for executing");
        // Check login status
        if(this.isLoggedIn()){
            System.out.println("in here for executing in if");
            ...
            System.out.println("in here for executing in else");
           checkLRegister();
        }*/
    }
    ...
    public void  logoutUser(){
        ...
        Intent i = new Intent(_context, NewSignUpActivity.class);
        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
