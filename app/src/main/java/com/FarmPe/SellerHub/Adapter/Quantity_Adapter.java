...
public class Quantity_Adapter extends RecyclerView.Adapter<Quantity_Adapter.MyViewHolder> {
    ...
    public Quantity_Adapter(Activity activity, List<SelectLanguageBean> moviesList) {
...
quantity_id= products.getLanguageid();
    ...
    /* holder.variety_txt.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View view) {
             AddCrops_Fragment.quantity.setText(products.getVendor());
