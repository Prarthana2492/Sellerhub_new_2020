...
public class Variety_Adapter2 extends RecyclerView.Adapter<Variety_Adapter2.MyViewHolder> {
    ...
    public Variety_Adapter2(Activity activity, List<SelectLanguageBean> moviesList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
     ...
     holder.variety_txt.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View view) {
             Spices_Details_Fragment.variety.setText(products.getVendor());
