...
public class QuantityPrice_Adapter2 extends RecyclerView.Adapter<QuantityPrice_Adapter2.MyViewHolder> {
    ...
    public QuantityPrice_Adapter2(Activity activity, List<SelectLanguageBean> moviesList) {
        ...
        holder.variety_txt.setOnClickListener(new View.OnClickListener() {
          ...
          // CInventory_Adapter.MyViewHolder viewHolder1 =(CInventory_Adapter.MyViewHolder) CInventory_Fragment.recyclerView.findViewHolderForAdapterPosition(CInventory_Adapter.selected_position);
              ...
              //  viewHolder1.text2.setText(products.getVendor());
                ...
                Spices_Details_Fragment.unit_of_measurement.setText(products.getVendor());
                Spices_Details_Fragment.drawer.closeDrawers();
