...
public class Urls {
 ...
 private static final String ROOT_URL = "http://13.232.185.209:9898/api/";///DEV
 ...
 public static final String GetFiltersOnTodayPaymentDetails =ROOT_URL +"SellingType/GetFiltersOnTodayPaymentDetails";
 public static final String GetFiltersOnThisWeekPaymentDetails =ROOT_URL +"SellingType/GetFiltersOnThisWeekPaymentDetails";
 public static final String GetPaymentDashboardDetails =ROOT_URL +"SellingType/GetPaymentDashboardDetails";
 public static final String DeleteProductDetails =ROOT_URL +"SellingType/DeleteInventoryDetails";
 public static final String GetProductDetails =ROOT_URL +"SellingType/GetSellDetails";
...
//MasterTable/AddUpdateFirmDetails
 // Refer n Earn
 ...
 public static final String GetStoreDetails = ROOT_URL + "SellingType/GetFirmDetails";
 ...
 public static final String AddUpdateStoreDetails= ROOT_URL+"MasterTable/AddUpdateFirmDetails";
